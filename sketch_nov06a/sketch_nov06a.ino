...
auto changeToPercent=[](int raw){return (raw/255)*100;};
...
void loop()
{
	...
	hourMotor->setSpeed(changeToPercent(pot_value)/(HOUR_HAND_OFFSET));					//set the speed of the hour hand. Turns the pot val to a percent, and slows it down by some additional factor
